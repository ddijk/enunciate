...
public class ValidationGroupHelper {
    public static final String JAVAX_VALIDATION_CONSTRAINTS_NOT_NULL = "javax.validation.constraints.NotNull";

    public static List<String> getGroupsOnField(String groupsAsString) {
    ...
    public static List<String> getActiveValidationGroups(String activeValidationGroups) {
    ...
    public static boolean isRequired(String targetGroups, Map<String, AnnotationMirror> fieldAnnotations) {
        ...
        AnnotationMirror annotationMirror = fieldAnnotations.get(JAVAX_VALIDATION_CONSTRAINTS_NOT_NULL);
