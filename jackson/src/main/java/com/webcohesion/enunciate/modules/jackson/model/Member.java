...
public class Member extends Accessor {
    ...
    @Override
    public <R, P> R accept(ElementVisitor<R, P> v, P empty) {

        BeanValidationContext beanValidationContext = new BeanValidationContext(getContext().getBeanValidationGroups(), getAnnotations());

        return v.visit(this, (P) beanValidationContext);
    }
